...
import 'package:internsquad/screens/bookmark.dart';
import 'package:internsquad/screens/tabscreen.dart';
import 'package:internsquad/screens/track.dart';
...
class _InternshipDetailScreenState extends State<InternshipDetailScreen> {
  ...
  showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(0, 'Application Confirmation',
        'Your application has been submitted', platform,
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    bool isPosted = await applicationProvider.postApplication(
                        application, Client());
                    if (isPosted) {
